...
if ($kode_ruang === '') {
    header('Location: ketersediaan_ruang.php');
    exit;
}
...
// === Insert: ambil peminjaman yang telah disetujui untuk ruangan ini (hari ini .. +6 hari) ===
$stmt3 = $conn->prepare("
...
<head>
    <meta charset="utf-8">
    <title>Detail Ruangan - Dosen | EasyRoom</title>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="hover-card p-4">
                    ...
                    <a href="ketersediaan_ruang.php" class="btn btn-outline-secondary btn-sm mt-3">
                                    ...
                                    <tbody>
                                        <?php while ($p = $peminjaman->fetch_assoc()): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?= safe_time_short($p['waktu_mulai'] ?? ''); ?> &ndash; <?= safe_time_short($p['waktu_selesai'] ?? ''); ?>
                                                </td>
